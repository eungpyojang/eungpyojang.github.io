...
Copy the block below into a new file inside `_posts/`.

Use a filename like:

`2026-08-19-short-title.md`

Then edit only the title, description, category, activity date, tags, permalink, and body text.
...
Write the activity story here in normal Markdown.
...
`image: /assets/activities/photo-name.jpg`
